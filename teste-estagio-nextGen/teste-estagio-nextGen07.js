...
function calculaTotalLeds(altura,largura) {
    ...
    if (altura*largura==0)
        return 0
    else if (altura*largura==1)
        return 4
    else if (altura*largura==2)
        return 6
    else
        return ((altura+1)*(largura+1))
}

console.log(calculaTotalLeds(2,2))
console.log(calculaTotalLeds(2,3))
console.log(calculaTotalLeds(2,4))
console.log(calculaTotalLeds(5,2))
console.log(calculaTotalLeds(10,20))
console.log(calculaTotalLeds(0,200))